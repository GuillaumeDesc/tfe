//Activation ou pas de skrollr afin d'eviter de fluidifier le site sur mobile et tablette
...
$(document).ready(function () {    
    ...
    if (window.mobilecheck() == true) {
        $(" .develop, .capsule, #connexione form, #onemore").addClass('relativegradient');
